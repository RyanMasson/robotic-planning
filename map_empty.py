...
class EECSMapEmpty():
    def __init__(self):
        ...
        self.horizontalWalls[7][1] = 0
        self.horizontalWalls[7][2] = 0
        self.horizontalWalls[7][3] = 0
        self.horizontalWalls[7][4] = 0
        self.horizontalWalls[7][5] = 0
        self.horizontalWalls[7][6] = 0
        ...
        self.verticalWalls[5][1] = 0
        self.verticalWalls[5][2] = 0
        ...
        self.verticalWalls[6][1] = 0
        self.verticalWalls[6][2] = 0
        self.verticalWalls[6][3] = 0
